  ...
  <div class="Home">
    ...
    <div class="subject">
      ...
      <div>
        ...
        <div>
          <p>To raise funds</p>
          <div><span>0</span><span> /20</span> sol</div>
        </div>
        <div>
          <div>
        ...
        <div class="introduce">
          <p>
            FIRST LONG COIN ON WHALES.MEME FIRST LONG COIN ON WHALES.MEME FIRST
            LONG COIN ON WHALES.MEME FIRST LONG COIN ON WHALES.MEME
          </p>
        </div>
        <div>
          <p>sfdf3rf3f...34424</p>
    ...
    <div class="screen">
      ...
      <div class="dxk">
        <el-checkbox v-model="checked1" label="Show animations" size="large" />
      </div>
      <div class="dxk">
...
const info = () => {
  get(
    `http://156.235.100.45:3000/memecoin/1/30/${sort.value}/${order.value}`,
    ""
  )
    .then((res) => {
...
const search = () => {
  ...
  get(`http://156.235.100.45:3000/memecoin/search/${searchaddress.value}`, "")
    .then((res) => {
